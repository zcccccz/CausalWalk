...
from models import Walk_with_bert, MultiClassFocalLossWithAlpha
...
dir_path = Path('outputs/causal_walk_politihop_2way/')
    ...
    for path in dev_data_list:
        ...
        with torch.no_grad():
            for index, data in enumerate(dev_tqdm_iterator):
                ...
                outputs, outputs1, probability = model(data, dev_centers_list[path], True)  # probability [batch,6,6]
